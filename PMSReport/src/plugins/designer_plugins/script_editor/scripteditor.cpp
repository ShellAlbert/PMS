...
//	splitter->setStretchFactor(0, 1);
    ...
    connect(textEdit , SIGNAL(undoAvailable(bool)), this, SLOT(textChanged()));
...
{
    CuteReport::ReportInterface * currentReport = core()->currentReport();
    if (currentReport)
        currentReport->setDirty(true);
}
